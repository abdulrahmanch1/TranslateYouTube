...
export async function POST(req: NextRequest) {
  try {
    ...
    if (lastBal < amt) return new NextResponse('Insufficient balance', { status: 402 })
    ...
    return new NextResponse(e?.message || 'Charge failed', { status: 400 })
  }
}
